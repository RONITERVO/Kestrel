...
Rust application boundary
  ...
  |     |-- Chatterbox: content-addressed low-bitrate speech plus producer-owned Voice Library conditioning for Research, chat, Tasks, and Studio Copilot
  ...
  |     |-- H3 shot auditions and before/between/after story transitions require explicit producer placement
