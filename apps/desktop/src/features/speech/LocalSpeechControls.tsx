...
import {
  ...
  MAX_PASSAGE_CHARS,
  splitForSpeech,
} from "../research/researchSpeechContent";
import type { LocalSpeechSnapshot, SpeechTiming } from "../../contracts/index";
import type { VoiceLibrarySnapshot, VoiceProfile } from "../../contracts/index";
import { VoiceLibraryDialog } from "./VoiceLibrary";
import { type SpeechProgressState, type SpeechSeekPassage } from "../../shared/components/spokenHighlight";
import {
  claimPlayback,
  clearPlayback,
