...
import { PromptPackVisualEditor } from "../features/control/PromptPackVisualEditor";
import { ResearchSpeechPlayer } from "../features/research/ResearchSpeech";
...
import { useInferenceTelemetry } from "../features/control/InferenceTelemetry";
import {
  STANDARD_CONTEXT_OPTIONS,
  STANDARD_OUTPUT_OPTIONS,
  findProvenHardwareProfile,
} from "../features/control/modelPolicy";
import type {
  AppSnapshot,
  ControlSettings,
  ControlSnapshot,
        ...
        <section className="content-section sources-section" id="sources">
          ...
          <div className="source-list">
            {report.sources.map((source, index) => (
              <div id={`source-${source.id}`} className={`source-card ${sourceFocus === source.id ? "focused" : ""} ${spokenPassageId?.startsWith(`source-${index + 1}`) ? "speech-passage-active" : ""}`} key={source.id}>
